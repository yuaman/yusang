...
// Slider & Sidebar
$(document).ready(function(){$("#full-width-slider").royalSlider({arrowsNav:true,loop:false,keyboardNavEnabled:true,controlsInside:false,imageScaleMode:"fill",slidesSpacing:0,arrowsNavAutoHide:false,arrowsNavHideOnTouch:true,autoScaleSlider:true,autoScaleSliderWidth:1160,autoScaleSliderHeight:560,controlNavigation:"bullets",thumbsFitInViewport:false,navigateByClick:true,startSlideId:0,autoPlay:false,transitionType:"move",deeplinking:{enabled:true,change:false},imgWidth:1160,imgHeight:560});$("#sidebar-slider").royalSlider({arrowsNav:false,loop:false,keyboardNavEnabled:true,controlsInside:false,imageScaleMode:"fill",slidesSpacing:0,arrowsNavAutoHide:false,autoScaleSlider:true,autoScaleSliderWidth:280,autoScaleSliderHeight:245,controlNavigation:"bullets",thumbsFitInViewport:false,navigateByClick:true,startSlideId:0,autoPlay:false,transitionType:"move",deeplinking:{enabled:true,change:false},imgWidth:280,imgHeight:245});})